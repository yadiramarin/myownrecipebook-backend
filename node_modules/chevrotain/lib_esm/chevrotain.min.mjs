...
`:case"\r":case"\u2028":case"\u2029":case"\\":case"]":throw Error("TBD");default:var l=this.popChar();return{type:"Character",value:i(l)}}},e.prototype.characterClass=function(){var l=[],v=!1;for(this.consumeChar("["),this.peekChar(0)==="^"&&(this.consumeChar("^"),v=!0);this.isClassAtom();){var y=this.classAtom(),m=y.type==="Character";if(m&&this.isRangeDash()){this.consumeChar("-");var A=this.classAtom(),g=A.type==="Character";if(g){if(A.value<y.value)throw Error("Range out of order in character class");l.push({from:y.value,to:A.value})}else a(y.value,l),l.push(i("-")),a(A.value,l)}else a(y.value,l)}return this.consumeChar("]"),{type:"Set",complement:v,value:l}},e.prototype.classAtom=function(){switch(this.peekChar()){case"]":case`
...
`,type:k.LexerDefinitionErrorType.MULTI_MODE_LEXER_WITHOUT_DEFAULT_MODE}),(0,Q.default)(e,E.MODES)||n.push({message:"A MultiMode Lexer cannot be initialized without a <"+E.MODES+`> property in its definition
`,type:k.LexerDefinitionErrorType.MULTI_MODE_LEXER_WITHOUT_MODES_PROPERTY}),(0,Q.default)(e,E.MODES)&&(0,Q.default)(e,E.DEFAULT_MODE)&&!(0,Q.default)(e.modes,e.defaultMode)&&n.push({message:"A MultiMode Lexer cannot be initialized with a ".concat(E.DEFAULT_MODE,": <").concat(e.defaultMode,">")+`which does not exist
`,type:k.LexerDefinitionErrorType.MULTI_MODE_LEXER_DEFAULT_MODE_VALUE_DOES_NOT_EXIST}),(0,Q.default)(e,E.MODES)&&(0,ut.default)(e.modes,function(i,a){(0,ut.default)(i,function(o,s){(0,sv.default)(o)&&n.push({message:"A Lexer cannot be initialized using an undefined Token Type. Mode:"+"<".concat(a,"> at index: <").concat(s,`>
`),type:k.LexerDefinitionErrorType.LEXER_DEFINITION_CANNOT_CONTAIN_UNDEFINED})})}),n}E.performRuntimeChecks=ak;function ok(e,t,r){var n=[],i=!1,a=(0,iv.default)((0,HL.default)((0,VL.default)(e.modes))),o=(0,av.default)(a,function(c){return c[mt]===k.Lexer.NA}),s=Av(r);return t&&(0,ut.default)(o,function(c){var f=Tv(c,s);if(f!==!1){var d=Ev(c,f),p={message:d,type:f.issue,tokenType:c};n.push(p)}else(0,Q.default)(c,"LINE_BREAKS")?c.LINE_BREAKS===!0&&(i=!0):(0,rr.canMatchCharCode)(s,c.PATTERN)&&(i=!0)}),t&&!i&&n.push({message:`Warning: No LINE_BREAKS Found.
	This Lexer has been defined to track line and column information,
	But none of the Token Types can be identified as matching a line terminator.
	See https://chevrotain.io/docs/guide/resolving_lexer_errors.html#LINE_BREAKS 
	for details.`,type:k.LexerDefinitionErrorType.NO_LINE_BREAKS_FLAGS}),n}E.performWarningRuntimeChecks=ok;function sk(e){var t={},r=(0,YL.default)(e);return(0,ut.default)(r,function(n){var i=e[n];if((0,za.default)(i))t[n]=[];else throw Error("non exhaustive match")}),t}E.cloneEmptyGroups=sk;function Ja(e){var t=e.PATTERN;if((0,ct.default)(t))return!1;if((0,vi.default)(t))return!0;if((0,Q.default)(t,"exec"))return!0;if((0,$e.default)(t))return!1;throw Error("non exhaustive match")}E.isCustomPattern=Ja;function gv(e){return(0,$e.default)(e)&&e.length===1?e.charCodeAt(0):!1}E.isShortPattern=gv;E.LineTerminatorOptimizedTester={test:function(e){for(var t=e.length,r=this.lastIndex;r<t;r++){var n=e.charCodeAt(r);if(n===10)return this.lastIndex=r+1,!0;if(n===13)return e.charCodeAt(r+1)===10?this.lastIndex=r+2:this.lastIndex=r+1,!0}return!1},lastIndex:0};function Tv(e,t){if((0,Q.default)(e,"LINE_BREAKS"))return!1;if((0,ct.default)(e.PATTERN)){try{(0,rr.canMatchCharCode)(t,e.PATTERN)}catch(r){return{issue:k.LexerDefinitionErrorType.IDENTIFY_TERMINATOR,errMsg:r.message}}return!1}else{if((0,$e.default)(e.PATTERN))return!1;if(Ja(e))return{issue:k.LexerDefinitionErrorType.CUSTOM_LINE_BREAK};throw Error("non exhaustive match")}}function Ev(e,t){if(t.issue===k.LexerDefinitionErrorType.IDENTIFY_TERMINATOR)return`Warning: unable to identify line terminator usage in pattern.
...
and Non-Terminal names start with a lower case letter.`;return t},buildAlternationPrefixAmbiguityError:function(e){var t=(0,lt.default)(e.prefixPath,function(i){return(0,nr.tokenLabel)(i)}).join(", "),r=e.alternation.idx===0?"":e.alternation.idx,n="Ambiguous alternatives: <".concat(e.ambiguityIndices.join(" ,"),`> due to common lookahead prefix
...
For Further details.`;return n},buildAlternationAmbiguityError:function(e){var t=(0,lt.default)(e.prefixPath,function(i){return(0,nr.tokenLabel)(i)}).join(", "),r=e.alternation.idx===0?"":e.alternation.idx,n="Ambiguous Alternatives Detected: <".concat(e.ambiguityIndices.join(" ,"),"> in <OR").concat(r,">")+" inside <".concat(e.topLevelRule.name,`> Rule,
`)+"<".concat(t,`> may appears as a prefix path in all these alternatives.
`);return n=n+`See: https://chevrotain.io/docs/guide/resolving_grammar_errors.html#AMBIGUOUS_ALTERNATIVES
For Further details.`,n},buildEmptyRepetitionError:function(e){var t=(0,Vv.getProductionDslName)(e.repetition);e.repetition.idx!==0&&(t+=e.repetition.idx);var r="The repetition <".concat(t,"> within Rule <").concat(e.topLevelRule.name,`> can never consume any tokens.
...
<\/script>
`;return s+c+f+d+p+h}Ui.createSyntaxDiagramsCode=zF});var tw=u(T=>{Object.defineProperty(T,"__esModule",{value:!0});T.Parser=T.createSyntaxDiagramsCode=T.clearCache=T.generateCstDts=T.GAstVisitor=T.serializeProduction=T.serializeGrammar=T.Terminal=T.Rule=T.RepetitionWithSeparator=T.RepetitionMandatoryWithSeparator=T.RepetitionMandatory=T.Repetition=T.Option=T.NonTerminal=T.Alternative=T.Alternation=T.defaultLexerErrorProvider=T.NoViableAltException=T.NotAllInputParsedException=T.MismatchedTokenException=T.isRecognitionException=T.EarlyExitException=T.defaultParserErrorProvider=T.tokenName=T.tokenMatcher=T.tokenLabel=T.EOF=T.createTokenInstance=T.createToken=T.LexerDefinitionErrorType=T.Lexer=T.EMPTY_ALT=T.ParserDefinitionErrorType=T.EmbeddedActionsParser=T.CstParser=T.VERSION=void 0;var YF=Yi();Object.defineProperty(T,"VERSION",{enumerable:!0,get:function(){return YF.VERSION}});var ji=fe();Object.defineProperty(T,"CstParser",{enumerable:!0,get:function(){return ji.CstParser}});Object.defineProperty(T,"EmbeddedActionsParser",{enumerable:!0,get:function(){return ji.EmbeddedActionsParser}});Object.defineProperty(T,"ParserDefinitionErrorType",{enumerable:!0,get:function(){return ji.ParserDefinitionErrorType}});Object.defineProperty(T,"EMPTY_ALT",{enumerable:!0,get:function(){return ji.EMPTY_ALT}});var Tm=Jr();Object.defineProperty(T,"Lexer",{enumerable:!0,get:function(){return Tm.Lexer}});Object.defineProperty(T,"LexerDefinitionErrorType",{enumerable:!0,get:function(){return Tm.LexerDefinitionErrorType}});var Ar=Et();Object.defineProperty(T,"createToken",{enumerable:!0,get:function(){return Ar.createToken}});Object.defineProperty(T,"createTokenInstance",{enumerable:!0,get:function(){return Ar.createTokenInstance}});Object.defineProperty(T,"EOF",{enumerable:!0,get:function(){return Ar.EOF}});Object.defineProperty(T,"tokenLabel",{enumerable:!0,get:function(){return Ar.tokenLabel}});Object.defineProperty(T,"tokenMatcher",{enumerable:!0,get:function(){return Ar.tokenMatcher}});Object.defineProperty(T,"tokenName",{enumerable:!0,get:function(){return Ar.tokenName}});var XF=tn();Object.defineProperty(T,"defaultParserErrorProvider",{enumerable:!0,get:function(){return XF.defaultParserErrorProvider}});var mn=ar();Object.defineProperty(T,"EarlyExitException",{enumerable:!0,get:function(){return mn.EarlyExitException}});Object.defineProperty(T,"isRecognitionException",{enumerable:!0,get:function(){return mn.isRecognitionException}});Object.defineProperty(T,"MismatchedTokenException",{enumerable:!0,get:function(){return mn.MismatchedTokenException}});Object.defineProperty(T,"NotAllInputParsedException",{enumerable:!0,get:function(){return mn.NotAllInputParsedException}});Object.defineProperty(T,"NoViableAltException",{enumerable:!0,get:function(){return mn.NoViableAltException}});var $F=to();Object.defineProperty(T,"defaultLexerErrorProvider",{enumerable:!0,get:function(){return $F.defaultLexerErrorProvider}});var Ve=G();Object.defineProperty(T,"Alternation",{enumerable:!0,get:function(){return Ve.Alternation}});Object.defineProperty(T,"Alternative",{enumerable:!0,get:function(){return Ve.Alternative}});Object.defineProperty(T,"NonTerminal",{enumerable:!0,get:function(){return Ve.NonTerminal}});Object.defineProperty(T,"Option",{enumerable:!0,get:function(){return Ve.Option}});Object.defineProperty(T,"Repetition",{enumerable:!0,get:function(){return Ve.Repetition}});Object.defineProperty(T,"RepetitionMandatory",{enumerable:!0,get:function(){return Ve.RepetitionMandatory}});Object.defineProperty(T,"RepetitionMandatoryWithSeparator",{enumerable:!0,get:function(){return Ve.RepetitionMandatoryWithSeparator}});Object.defineProperty(T,"RepetitionWithSeparator",{enumerable:!0,get:function(){return Ve.RepetitionWithSeparator}});Object.defineProperty(T,"Rule",{enumerable:!0,get:function(){return Ve.Rule}});Object.defineProperty(T,"Terminal",{enumerable:!0,get:function(){return Ve.Terminal}});var Fo=G();Object.defineProperty(T,"serializeGrammar",{enumerable:!0,get:function(){return Fo.serializeGrammar}});Object.defineProperty(T,"serializeProduction",{enumerable:!0,get:function(){return Fo.serializeProduction}});Object.defineProperty(T,"GAstVisitor",{enumerable:!0,get:function(){return Fo.GAstVisitor}});var ZF=ym();Object.defineProperty(T,"generateCstDts",{enumerable:!0,get:function(){return ZF.generateCstDts}});function JF(){console.warn(`The clearCache function was 'soft' removed from the Chevrotain API.
	 It performs no action other than printing this message.
	 Please avoid using it as it will be completely removed in the future`)}T.clearCache=JF;var QF=gm();Object.defineProperty(T,"createSyntaxDiagramsCode",{enumerable:!0,get:function(){return QF.createSyntaxDiagramsCode}});var ew=function(){function e(){throw new Error(`The Parser class has been deprecated, use CstParser or EmbeddedActionsParser instead.	
See: https://chevrotain.io/docs/changes/BREAKING_CHANGES.html#_7-0-0`)}return e}();T.Parser=ew});"use strict";export default tw();
